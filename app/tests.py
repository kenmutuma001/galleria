...
class LocationTestClass(TestCase):
    ...
    def test_update_method(self):
        ...
        self.location = Location.objects.filter(
            name='Nairobi').update(name='Nakuru')
...
class ImageTestClass(TestCase):
    ...
    def setUp(self):
        ...
        self.location.save_location()
        self.image = Image(id=1, title="test", description="test description",
                           location=self.location, image_url="path/to/image")
    ...
    def test_update_image(self):
        self.image.save_image()
        self.image = Image.objects.filter(
            id=1).update(image_url="new/path/to/image")
    ...
    def test_search_by_category(self):
        ...
        self.image = Image.get_image_by_id(1).category.add(self.category)
